...
@enderror
                <div class="form-group{{ $errors->has('kd_makul') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="kd_makul" class="form-control col-md-12" placeholder="Masukkan Kode Makul" value={{$makul->kd_makul}}>
                    <small class="text-danger">{{ $errors->first('kd_makul') }}</small>
                </div>
                <div class="form-group">
                    <label for="nama">Nama Makul</label>
                    <input type="text" name="nama_makul" class="form-control col-md-12" placeholder="Masukkan Nama Makul" value={{$makul->nama_makul}}>
                </div>
                {{-- ------------------------------------- --}}
            ...
            {{-- ----------------------------------------------- --}}
                ...
                <div class="form-group{{ $errors->has('sks') ? ' has-error' : '' }}">
                    ...
                    <input type="number" name="sks" class="form-control col-md-12" placeholder="Masukkan SKS" value={{$makul->sks}}>
